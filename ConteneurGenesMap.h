...
* Auteur      : Gergi Younis							  *
* Travail     : TP5										  *
* Description : Définition de la classe multimap de gènes *
***********************************************************/
#ifndef CONTENEURGENESMAP
#define CONTENEURGENESMAP
...
/****************************************************************
* Fonction : inserer()											*
* Description : Ajoute un gène dans la map des gènes			*
...
/************************************************************
* Fonction : retirer()										*
* Description : Retire un gène de la map à partir de son id	*
...
/**************************************************
* Fonction : vider()							  *
* Description : Retire tous les gènes de la map   *
* Paramètres : Aucun 							  *
* Valeur de retour : Aucune						  *
***************************************************/
	virtual void vider();
...
* Description : Affiche les gènes par ordre alphabétique d'espèce et pour chaque *
*				espèce par ordre alphabétique de nom							 *
* Paramètres : Flux de sortie (stream)											 *
* Valeur de retour : Aucune														 *
**********************************************************************************/
...
private:
	multimap<string, Gene*> mapGenes_; // On utilise l'espèce du gène comme clé
};


#endif // !CONTENEURGENESMAP